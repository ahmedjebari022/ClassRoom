        ...
        <div className="card w-full max-w-md bg-base-100 shadow-2xl relative z-10 animate-fade-in">
          <div className="card-body">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-base-content/70 mt-2">Sign in to your ClassRoom account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="/forgot-password" className="link link-primary text-sm hover:link-hover">
                  Forgot password?
                </a>
              </div>
              ...
              <button
                type="submit"
                className={`btn btn-primary w-full text-white ${isLoading ? 'loading' : ''} transition-all duration-300 hover:scale-[1.02]`}
                disabled={isLoading}
              >
            ...
            <div className="text-center mt-6">
              <p className="text-base-content/70">
                ...
                <a href="/register" className="link link-primary hover:link-hover font-medium">
                  Sign up here
                </a>
              </p>
            </div>
